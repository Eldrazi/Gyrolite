...
{
    public class PinkSloman_Phase3 : ModNPC
    {
        public override void SetDefaults()
        {
            npc.name = "Pink Sloman";
            npc.width = 28;
            npc.height = 44;
        ...
        public override bool CheckDead()
        {
            for (int i = 0; i < 10; ++i)
            {
                int dust11 = Dust.NewDust(npc.position, npc.width, npc.height, DustID.PinkSlime, 0f, -2f, 40, default(Color), 2f);
