...
namespace Gyrolite.Items.Weapons.Summoner
{
    public class BlueSlimeStaff : ModItem
    {
        ...
        {
            item.name = "Blue Slime Staff";
            item.width = 26;
            item.height = 28;
            item.toolTip = "Summons a Blue Slime to fight for you";
            ...
            item.noMelee = true;
            item.mana = 1;
            item.shoot = mod.ProjectileType("BlueSlimeMinion");
            item.buffType = mod.BuffType("BlueSlimeMinionBuff");
            item.buffTime = 3600;
