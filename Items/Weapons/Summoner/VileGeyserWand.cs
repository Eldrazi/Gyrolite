...
{
    public class VileGeyserWand : ModItem
    {
        public override void SetDefaults()
        {
            item.name = "Vile Geyser Wand";
            item.width = 26;
            item.height = 28;
            item.toolTip = "?";
            ...
            item.shoot = mod.ProjectileType("VileGeyserMinion");
            item.buffType = mod.BuffType("VileGeyserMinionBuff");
            item.buffTime = 3600;
