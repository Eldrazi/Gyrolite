...
{
    public class YellowSlimeStaff : ModItem
    {
        public override void SetDefaults()
        {
            item.name = "Yellow Slime Staff";
            item.width = 26;
            item.height = 28;
            item.toolTip = "Summons a Yellow Slime to fight for you";
            ...
            item.noMelee = true;
            item.mana = 1;
            item.shoot = mod.ProjectileType("YellowSlimeMinion");
            item.buffType = mod.BuffType("YellowSlimeMinionBuff");
            item.buffTime = 3600;
