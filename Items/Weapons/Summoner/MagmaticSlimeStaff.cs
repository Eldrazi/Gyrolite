...
{
    public class MagmaticSlimeStaff : ModItem
    {
        public override void SetDefaults()
        {
            item.name = "Magmatic Slime Staff";
            item.width = 26;
            item.height = 28;
            item.toolTip = "Summons a Magmatic Slime to fight for you";
            ...
            item.noMelee = true;
            item.mana = 1;
            item.shoot = mod.ProjectileType("MagmaticSlimeMinion");
            item.buffType = mod.BuffType("MagmaticSlimeMinionBuff");
            item.buffTime = 3600;
