...
{
    public class RedSlimeStaff : ModItem
    {
        public override void SetDefaults()
        {
            item.name = "Red Slime Staff";
            item.width = 26;
            item.height = 28;
            item.toolTip = "Summons a Red Slime to fight for you";
            ...
            item.noMelee = true;
            item.mana = 1;
            item.shoot = mod.ProjectileType("RedSlimeMinion");
            item.buffType = mod.BuffType("RedSlimeMinionBuff");
            item.buffTime = 3600;
