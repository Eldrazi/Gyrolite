...
{
    public class ShadowFireRing : ModItem
    {
        public override void SetDefaults()
        {
            item.name = "Ring of Shadow Fire";
            item.width = 22;
            item.height = 24;
            item.toolTip = "??";
            ...
            item.shoot = mod.ProjectileType("RingProjectile_ShadowFire");
            item.shootSpeed = 14;
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            gp.ringEffects[1] = BuffID.ShadowFlame;
        }
    }
}
