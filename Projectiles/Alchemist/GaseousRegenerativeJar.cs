...
{
    public class GaseousRegenerativeJar : ModProjectile
    {
        public override void SetDefaults()
        {
            projectile.name = "Gaseous Regenerative Jar";
            projectile.width = 12;
        ...
        {
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, mod.ProjectileType("RegenerativeCloud"), 0, 0, projectile.owner);
        }
