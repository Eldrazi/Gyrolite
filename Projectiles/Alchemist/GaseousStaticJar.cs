...
{
    public class GaseousStaticJar : ModProjectile
    {
        public override void SetDefaults()
        {
            projectile.name = "Gaseous Static Jar";
            projectile.width = 12;
        ...
        {
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, mod.ProjectileType("StaticCloud"), 0, 0, projectile.owner);
        }
