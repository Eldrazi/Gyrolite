...
{
    public class GaseousVacuumJar : ModProjectile
    {
        public override void SetDefaults()
        {
            projectile.name = "Gaseous Vacuum Jar";
            projectile.width = 12;
        ...
        {
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, mod.ProjectileType("VacuumCloud"), 0, 0, projectile.owner);
        }
